# The prompt for this is to create a function that returns the minimum difference between the absolute value of any two "halves" of an array when the array is split along each consecutive item. 
