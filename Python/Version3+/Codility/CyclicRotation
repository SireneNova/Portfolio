...
#I also learned that in Python, equality is set by reference by default. Setting B=A made B identical to A in memory, which is why .copy() was needed in this method.
