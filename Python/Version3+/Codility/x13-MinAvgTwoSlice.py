...
# My orginal versions below returned the correct answer, but is not optimal for speed, so gives 60% O(N^2). It uses prefix sums. I thought the issue was the use of a nested loop, but removing it didn't help (see commented solution below).
