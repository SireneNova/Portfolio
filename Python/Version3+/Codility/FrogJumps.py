# A frog wants to get from point X to point Y, and jumps a fixed distance of D. Find the minimum number of frog jumps given starting point X, end point Y, and jump size D.
