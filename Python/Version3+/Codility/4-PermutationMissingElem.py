# In a permutation of consecutive integers starting with 1, print the missing element. Assume there is one missing element. E.g. in [3,5,1,2] the missing element is 4.
